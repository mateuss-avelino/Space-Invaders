class SoundEffects {
    constructor() {
        this.shootSounds = [
            new Audio("src/audios/shoot.mp3"),
            new Audio("src/audios/shoot.mp3"),
            new Audio("src/audios/shoot.mp3"),
            new Audio("src/audios/shoot.mp3"),
            new Audio("src/audios/shoot.mp3"),
        ...
        this.explosionSounds = new Audio("src/audios/explosion.mp3");
        this.nextLevelSounds = new Audio("src/audios/next_level.mp3");
